...
# Model 2 Preparation
```{r}
df_ranger = read_csv("clean_diabetes_data.csv")
...
factor_vars <- c("high_bp", "high_chol", "chol_check", "smoker", "stroke", 
                 "heart_diseaseor_attack", "phys_activity", "fruits", "veggies", 
                 "hvy_alcohol_consump", "any_healthcare", "no_docbc_cost", "diff_walk", 
                 "sex", "gen_hlth", "age", "education", "income")

df_ranger[factor_vars] <- lapply(df_ranger[factor_vars], factor)
df_ranger
```
